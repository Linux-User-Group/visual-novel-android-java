...
public class Story12 extends AppCompatActivity {
    ...
    //local server
//    private String URL = "http://192.168.1.7/novel/story/story12.php";

    //online serve
    private String URL = "https://novelfaris.000webhostapp.com/story/story12.php";
        ...
        textStory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (i >= 0 && i < cr.getSize()){
                    ...
                    startActivity(new Intent(getApplicationContext(), Story13.class));
                    audio.setVolume(0,0);
                    audio.stop();
