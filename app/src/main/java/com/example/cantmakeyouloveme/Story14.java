...
public class Story14 extends AppCompatActivity {
    ...
    //local server
//    private String URL = "http://192.168.1.7/novel/story/story14.php";

    //online serve
    private String URL = "https://novelfaris.000webhostapp.com/story/story14.php";
...
//                txtStatus.setText(error.toString());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_story14);

        Intent intent = getIntent();

        audio = MediaPlayer.create(this, R.raw.rain_sound);
        audio.setVolume(1,1);
        audio.start();
        ...
        textStory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (i >= 0 && i < cr.getSize()){
                    ...
                    startActivity(new Intent(getApplicationContext(), Story15.class));
                    audio.setVolume(0,0);
                    audio.stop();
