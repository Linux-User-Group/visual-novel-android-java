...
public class Story13 extends AppCompatActivity {
    ...
    //local server
//    private String URL = "http://192.168.1.7/novel/story/story13.php";

    //online serve
    private String URL = "https://novelfaris.000webhostapp.com/story/story13.php";
...
//                txtStatus.setText(error.toString());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        audio = MediaPlayer.create(this, R.raw.cafe_sound);
        audio.setVolume(1,1);
        audio.start();
        ...
        textStory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (i >= 0 && i < cr.getSize()){
                    ...
                    startActivity(new Intent(getApplicationContext(), Story14.class));
                    audio.setVolume(0,0);
                    audio.stop();
