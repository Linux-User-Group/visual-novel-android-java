...
public class Story16 extends AppCompatActivity {
    ...
    //local server
//    private String URL = "http://192.168.1.7/novel/story/story16.php";

    //online serve
    private String URL = "https://novelfaris.000webhostapp.com/story/story16.php";
...
//                txtStatus.setText(error.toString());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_story16);
        ...
        textStory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (i >= 0 && i < cr.getSize()){
                    ...
                    startActivity(new Intent(getApplicationContext(), Story17.class));
                    audio.setVolume(0,0);
                    audio.stop();
